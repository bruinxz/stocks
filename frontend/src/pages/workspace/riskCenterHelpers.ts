...
export const RULE_ID_META: Readonly<Record<string, RuleIdMeta>> = Object.freeze({
  ...
  // ---- PR-O2 (2026-06-29) — 涨停板战法 20+ pattern. 流派 1 落地率 0% → 50%. ----
  // backend LimitUpBoardDetector 每日 15:30 跑 limit_up_stocks 全表 + classifier
  // 命中即写 RiskAlert (rule_id='limit_up_<pattern>', level=MEDIUM).
  // 前端在 risk_center 给每个 pattern 1 行中文 + icon, opportunity 类显示绿色.
  limit_up_one_word: {
    label: '🚀 一字板',
    icon: '🚀',
    color: '#dc2626',
  ...
  limit_up_second_board_accelerate: {
    label: '📈 二板加速',
    icon: '📈',
    color: '#dc2626',
    category: 'opportunity',
  ...
  limit_up_high_consecutive_accelerate: {
    label: '📈 高位连板加速',
    icon: '📈',
    color: '#dc2626',
    category: 'opportunity',
  ...
  limit_up_consecutive_height_play: {
    label: '👑 板块最高板',
    icon: '👑',
    color: '#a16207',
    category: 'opportunity',
  ...
  limit_up_broken_refill_next_day: {
    label: '🔄 烂板反包',
    icon: '🔄',
    color: '#0891b2',
    category: 'opportunity',
  ...
  limit_up_broken_refill_with_turnover: {
    label: '💥 炸板换手回封',
    icon: '💥',
    color: '#f97316',
    category: 'opportunity',
