...
describeLive('Tab2 USStockPicks live disposable-PG container', () => {
  test('authenticatedFetch crosses localhost HTTP and renders the strict v0.3.1 recommendation', async () => {
    ...
    const canonicalPath = recommendationLatestUrl('us_preferred', 'us');
    ...
    const fetchTransport = jest
      ...
      .mockImplementation(async (input, init = {}) => {
        ...
        // Transport-only shim: preserve the page-generated request and cross a
        // real localhost socket. No response body is constructed in this test.
