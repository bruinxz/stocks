"""DataPipeline-owned canonical I-JSON serialization.

The supported domain is intentionally narrower than arbitrary Python objects:
null, booleans, strings, safe integers, finite binary64 numbers, arrays, and
string-keyed objects. This keeps source fact hashing deterministic and
PostgreSQL JSONB-compatible without importing a private AI-layer helper.
"""
