 ...
 * NorthboundFollowStrategy / SectorRotationLeaderStrategy /
 * AShareConstraintEngine 的 isSTName 逻辑一致）。
 *
 * 注意：若 ST 判定规则变化，需要同步更新 6 处。这是单独实现以换取测试隔离
 * 与各策略独立演进能力的 trade-off。
 */
