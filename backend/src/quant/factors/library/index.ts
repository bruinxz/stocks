 ...
 * 东财问答热度因子 + US-035 股东户数环比变化因子 + US-036 渐进强爆因子
 * + US-090 内部人净买入因子 + US-091 融资余额变化因子 (顺序按文件名字母序，
 * 与 .listNames() 排序一致)：
 *   analyst_consensus / dragon_tiger / earnings_surprise / east_money_qa /
 *   gradual_breakout / growth / insider_trade / liquidity / low_vol /
 *   margin_flow / momentum / momentum_reversal / money_flow / northbound /
 *   quality / quality_high / shareholder_concentration / value
 */
