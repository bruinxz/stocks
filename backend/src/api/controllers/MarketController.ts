...
export class MarketController {
   ...
   *   }
   */
  getIndustryFlowIntraday = async (_req: Request, res: Response) => {
    // IndustryFlowIntraday table deleted
    res.json({ success: true, data: { date: null, industries: [], snapshot_ts_list: [] } });
  };
}
