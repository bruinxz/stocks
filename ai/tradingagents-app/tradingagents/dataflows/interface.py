...
# Import modular akshare components
...
VENDOR_METHODS = {
    ...
    "get_realtime_quotes": {
        "internal_api": InternalStockAPI.get_realtime_quotes,
    },
    "get_intraday_data": {
        "internal_api": InternalStockAPI.get_intraday_data,
    },
    # technical_indicators
    "get_indicators": {
...
def route_to_vendor(method: str, *args, **kwargs):
    ...
    # Special case: internal_api methods
    if method in ["get_realtime_quotes", "get_intraday_data"]:
        vendor_config = "internal_api"
    else:
