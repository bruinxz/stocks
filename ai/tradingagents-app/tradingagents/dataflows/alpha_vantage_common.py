...
def get_api_key() -> str:
    ...
    api_key = get_env_or_config("ALPHA_VANTAGE_API_KEY")
    if not api_key:
    ...
    def _do_request():
        ...
        try:
            ...
            if "Information" in response_json:
                ...
                if "rate limit" in info_message.lower() or "api key" in info_message.lower() or "thank you for using alpha vantage" in info_message.lower():
