...
POSTGRES_USER = os.getenv("POSTGRES_USER") or os.getenv("DB_USER", "postgres")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD") or os.getenv("DB_PASSWORD", "")
POSTGRES_HOST = os.getenv("POSTGRES_HOST") or os.getenv("DB_HOST", "127.0.0.1")
POSTGRES_PORT = os.getenv("POSTGRES_PORT") or os.getenv("DB_PORT", "5432")
POSTGRES_DB = os.getenv("POSTGRES_DB") or os.getenv("DB_NAME", "stock_backtest")
