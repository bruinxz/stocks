...
def create_llm_client(
    ...
    **kwargs,
    ...
    Args:
        provider: LLM provider (openai, anthropic, google, xai, ollama, openrouter, volcengine)
    ...
    if provider_lower in ("volcengine", "ark"):
        return VolcengineClient(model, base_url, **kwargs)
