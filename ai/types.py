...
RISK_TRIGGER_CODES = frozenset({
    "SEC_HALT", "EARNINGS_BLACKOUT", "FDA_ADCOM", "LITIGATION_MATERIAL",
    "SHORT_SQUEEZE_RISK", "LIQUIDITY_THIN", "INSIDER_LOCKUP", "DEBT_COVENANT",
    "REGULATORY_REVIEW", "ST_TAG", "PRICE_LIMIT_APPROACH", "SUSPENDED",
})
