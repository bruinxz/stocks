...
| P2-4 | DOING | 策略可视化编辑器 MVP     | 启停/仓位/环境/晋级规则             | 修改后有审计记录                           |
...
- 策略启停/默认参数编辑仍复用「策略权重」Tab，下一步将增强“环境适用/晋级规则”的可视化编辑与审计。
...
| ID   | 状态 | 任务             | 交付物             | 验收方式                             |
| ---- | ---- | ---------------- | ------------------ | ------------------------------------ |
| P5-1 | TODO | 每日交易纪律模型 | discipline summary | 输出最大新增仓位、单票上限、禁买规则 |
...
| P6-3 | TODO | 高级信息折叠规范     | 参数/JSON/审计折叠                   | 普通用户不被复杂细节打扰      |
